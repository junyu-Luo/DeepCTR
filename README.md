...
- Dense feature add: normal, min_max, auto discretization 
- Sparse feature Vocab lookup and missing value filling
- VarLenSparse sequence feature padding length 
- Calculation of similarity between Emb features
- The data generate can be used with [DataFlow](https://github.com/junyu-Luo/DataFlow)
