...
def MMOE(dnn_feature_columns, num_experts=3, expert_dnn_hidden_units=(256, 128),
    ...
    group_embedding_dict, dense_value_list = input_from_feature_columns(process_features, linear_feature_columns,
                                                                        l2_reg_embedding,
    ...
    for task_type, task_name, mmoe_out in zip(task_types, task_names, mmoe_outs):
        ...
        dnn_logit = tf.keras.layers.Dense(1, use_bias=False, activation=None)(tower_output)
