...
def xDeepFM(linear_feature_columns, dnn_feature_columns, dnn_hidden_units=(256, 128, 64),
    ...
    linear_logit = get_linear_logit(process_features, linear_feature_columns, seed=seed, prefix='linear',
                                    l2_reg=l2_reg_linear, arithmetic_features=arithmetic_features)
